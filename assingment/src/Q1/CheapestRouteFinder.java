...
class CheapestRouteFinder {
    ...
    /**
     * Finds the cheapest cost to travel from the source to the destination node within the given time constraint

     */
    public static int findCheapestRoute(int[][] routes, int[] charges, int source, int destination, int timeConstraint) {
    ...
    public static void main(String[] args) {
        int[][] routes = {{0,1,5}, {0,3,2}, {1,2,5}, {3,4,5}, {4,5,6}, {2,5,5}};
        int[] charges = {10,2,3,25,25,4};
        int source = 0;
        int destination = 5;
        int timeConstraint = 14;
        int cheapestCost = findCheapestRoute(routes, charges, source, destination, timeConstraint);
